...
public class AdvancedSearchFormPage extends CAOMSearchFormPage
{
    ...
    public AdvancedSearchFormPage(final WebDriver driver) throws Exception
    {
        super(driver);
    }


    public AdvancedSearchFormPage doLogin(String username, String password) throws Exception
    {
        ...
        return new AdvancedSearchFormPage(driver);
    }

    public AdvancedSearchFormPage doLogout() throws Exception
    {
