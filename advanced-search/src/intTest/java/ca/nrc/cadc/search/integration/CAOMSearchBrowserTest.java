...
public class CAOMSearchBrowserTest extends AbstractAdvancedSearchIntegrationTest {
    ...
    public void searchCAOM() throws Exception {
        ...
        // Return to query page and do IRIS search, test quick download
        // Do this test last as on slower machines (vms) the quickSearchTarget download
        // function ties up the TAP service and will foul any DataTrain load afterward.
        searchFormPage = searchResultsPage.queryTab();
        searchFormPage.reset();
